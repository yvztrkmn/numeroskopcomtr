...
const interpretations: { [key: number]: { title: string; description: string } } = {
  ...
  9: { title: 'Hümanist', description: 'Evrensel sevgi, fedakarlık ve bilgelik sizin özünüzdür. İnsanlığa hizmet etme ve dünyayı daha iyi bir yer yapma arzusu taşırsınız. Anlayışlı, cömert ve idealist yapınızla geniş kitlelere dokunursunuz.' },
